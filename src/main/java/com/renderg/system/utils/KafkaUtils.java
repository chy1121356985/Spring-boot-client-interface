...
//        System.out.println("发送结束");
        ...
        KafkaStreamClient kafkaStreamClient =  KafkaUtils.bulidClient().createKafkaStreamClient("10.6.0.136", 9092, "consumer-45");
        kafkaStreamClient.pollMsg("aspera-file-events", new HeaderInterface() {
            @Override
